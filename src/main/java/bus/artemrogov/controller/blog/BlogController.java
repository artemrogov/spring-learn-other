...
import bus.artemrogov.domain.utils.PostBuilder;
...
import bus.artemrogov.domain.request.CommentRequest;
import bus.artemrogov.domain.request.PostRequest;
import bus.artemrogov.domain.request.TagRequest;
import bus.artemrogov.domain.request.TagRequestIds;
import bus.artemrogov.domain.response.CommentDtoResponse;
import bus.artemrogov.domain.response.PostDtoResponse;
import bus.artemrogov.domain.response.TagResponse;
